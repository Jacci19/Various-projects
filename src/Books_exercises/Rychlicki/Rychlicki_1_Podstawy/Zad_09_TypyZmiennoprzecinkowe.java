...
/*      Zad 9_2
        ...
        d) symbole specjalne: Double.NaN (ang. Not-a-Number), np. wynik pierwiastkowania liczby ujemnej, Double.NEGATIVE INFINITY (np. wynik dzielenia –1/0,0),
...
*/
        ...
        // double[] d = {0.01, 0.1, 1.0, 10.0, 100.0};
        // double[] d = {1.367, 1367, 1.367e-12, 1.367e12, 13.67, -13.67};
        // double[] d = {Double.NaN, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY};
        // double[] d = {0.0, -0.0, Double.MIN_VALUE, Double.MAX_VALUE, 2.2250738585072014e-308};
        for (double x : d) {
