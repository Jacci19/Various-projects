...
/*                Zadanie 18.8.
    ...
    — nazwy sugerująróżnicę w działaniu tych metod. Utwórz równieżmetodędodającą do wszystkich elementów tablicy określonąwartość<void addToArray(int[] tab, int d)>.
...
/*
        ...
        Ponadto utwórz metodędodającądo wszystkich elementów tablicy określonąwartość<void addToArray(double[] tab, double d)>. Napisz program demonstrujący działanie tych metod.
...
//
    ...
    void addToArray(int[] tab, int d) {             //dodaje do każdego elementu tablicy LLC stałą d
        for (int i = 0; i < tab.length; i++) {
            tab[i] += d;
        }
    }
    ...
    void addToArray(double[] tab, double d){        //dodaje do każdego elementu tablicy LLR stałą d
        for (int i = 0; i < tab.length; i++) {
            tab[i] += d;
        }
    }
