...
public abstract class CommonDao {
    ...
    public <T extends BaseModel, I> T findById(Class<T> cls, Integer id) throws ApplicationException {                                           //znajduje po ID, T - metoda zwraca ten sam typ na którym operujemy
        try {
            Dao<T, I> dao = getDao(cls);
