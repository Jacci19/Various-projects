package JavaFX.Almas_progs.Hangman;
...
/**    https://www.youtube.com/watch?v=iphlcKmnHjI&index=15&list=PL4h6ypqTi3RTIoPa_Qz3haEo3OXJQqOwc   */
...
public class HangmanMain extends Application {
    ...
    private SimpleStringProperty word = new SimpleStringProperty();                 /**    * The word to guess     */
    private SimpleIntegerProperty lettersToGuess = new SimpleIntegerProperty();     /**     * How many letters left to guess     */
    private SimpleIntegerProperty score = new SimpleIntegerProperty();              /**     * Current score     */
    private float scoreModifier = 1.0f;                                             /**     * How many points next correct letter is worth     */
    private SimpleBooleanProperty playable = new SimpleBooleanProperty();           /**     * Is game playable     */


    /** List for letters of the word {@link #word}. It is backed up by the HBox children list, so changes to this list directly affect the GUI     */
