...
public class Zad_07_Integer {
    public Zad_07_Integer() {
        ...
        System.out.println("BlackJack_FX = "+d);
        ...
        System.out.println("Porównanie obiektu c z obiektem BlackJack_FX? "+ c.compareTo(d));
        System.out.println("Porównanie obiektu BlackJack_FX z obiektem c? "+ d.compareTo(c));
